        ...
        <div>
             <Dialog open={isDialogOpen} onOpenChange={(open) => {
                ...
                <DialogContent className=" shadow-white/20 shadow-lg">
                        ...
                        <DialogDescription>
                            <div className="mt-5">
                                ...
                                <div className="mt-4">
                                    ...
                                    <Input placeholder="Ex: Grocery" className="bg-white/40 focus:bg-white" onChange={(e) => setName(e.target.value)}/>
                                </div>
                                <div className="mt-4">
                                    ...
                                    <Input placeholder="Ex: 1000" className="bg-white/40 focus:bg-white" onChange={(e) => {amountToUSD(e); setXAmount(e.target.value)}}/>
                                </div>
                    ...
                    <DialogFooter>
                        <DialogClose asChild>
                            <Button disabled={!(name && amount)} className="w-full rounded-full mt-3 bg-secondary hover:bg-primary" onClick={()=> onCreateIncomes()}>Add Budget</Button>
                        </DialogClose>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
